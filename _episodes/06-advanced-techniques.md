...
## Exercise: Use GRU Model for Forecasting

- Modify the sequence length to 50 used in the LSTM model and observe its impact on the model's performance.
- Modify the hidden layers of the GRU model to 8 and train the model again. Plot the observed vs prediction for the test dataset.
